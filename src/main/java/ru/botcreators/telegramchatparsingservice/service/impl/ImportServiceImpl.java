...
public class ImportServiceImpl implements ImportService {
    ...
    @Override
    public ExportResponse importChatHistory(MultipartFile file) throws IOException {
        TelegramChatExport telegramChatExport = objectMapper.readValue(file.getInputStream(), TelegramChatExport.class);
